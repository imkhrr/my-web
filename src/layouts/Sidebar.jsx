                            ...
                            <NavLink to="/commodity" activeClassName="is-active">
                                <span className="icon-text">
                                    <span className="icon is-teal">
                                        <i> <CgMenuBoxed className="react-icons-sidebar" /> </i>
                                    </span>
                                    <span>Barang</span>
                                </span>
                            </NavLink>
                            ...
                            <NavLink to="/user" activeClassName="is-active">
                                <span className="icon-text">
                                    <span className="icon is-purple">
                                        <i> <CgProfile className="react-icons-sidebar" /> </i>
                                    </span>
                                    <span>User</span>
                                </span>
                            </NavLink>
                            ...
                            <NavLink to="/customers" activeClassName="is-active">
                                <span className="icon-text">
                                    <span className="icon is-deep-orange">
                                        <i> <CgUserList className="react-icons-sidebar" /> </i>
                                    </span>
                                    <span>Pelanggan</span>
                                </span>
                            </NavLink>
                            ...
                            <NavLink to="/suppliers" activeClassName="is-active">
                                <span className="icon-text">
                                    <span className="icon is-pink">
                                        <i> <CgShoppingBag className="react-icons-sidebar" /> </i>
                                    </span>
                                    <span>Suppliers</span>
                                </span>
                            </NavLink>
                            ...
                            <NavLink to="/penjualan" activeClassName="is-active">
                                <span className="icon-text">
                                    <span className="icon is-indigo">
                                        <i> <CgBookmark className="react-icons-sidebar" /> </i>
                                    </span>
                                    <span>Penjualan</span>
                                </span>
                            </NavLink>
                            ...
                            <NavLink to="/stokopname" activeClassName="is-active">
                                <span className="icon-text">
                                    <span className="icon is-brown">
                                        <i> <CgMenuGridO className="react-icons-sidebar" /> </i>
                                    </span>
                            ...
                            <NavLink to="/statistik" activeClassName="is-active">
                                <span className="icon-text">
                                    <span className="icon is-blue-grey">
                                        <i> <CgChart className="react-icons-sidebar" /> </i>
                                    </span>
                                    <span>Statistik</span>
                                </span>
                            </NavLink>

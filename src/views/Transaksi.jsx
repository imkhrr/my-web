                                ...
                                <div className="columns">
                                    <div className="column">
                                        <div className="pb-2 is-flex is-justify-content-space-between">
                                            ...
                                            <button className="button is-info is-small is-light" onClick={this.showClick} >
                                                <i className="icon"> <CgAdd className="react-icons-sidebar" /> </i>
                                    ...
                                    <div className="column is-4">
                                        ...
                                        <div className="box" style={{ minHeight: "70vh" }}>
                                            <div className="field">
                                                ...
                                                <input className="input is-small" type="text" placeholder="Nama Pelanggan" />
                                            </div>
                                            <div className="field">
                                                <label className="label is-small">Tanggal</label>
                                                <input className="input is-small" type="text" placeholder="Tanggal" />
                                            </div>
                                            <div className="field">
                                                <label className="label is-small">No. Struk</label>
                                                <input className="input is-small" type="number" placeholder="No. Struk" />
                                            </div>
                                            <div className="field">
                                                <label className="label is-small">Keterangan</label>
                                                <textarea className="textarea is-small" placeholder="Keterangan" />
                                            </div>
                                            <div className="field">
                                            ...
                                            <div className="field">
                                                <div className="field is-flex is-justify-content-space-between">
                                                    ...
                                                    <span className="label has-text-info pr-2"> Rp. 40.0000 </span>
                                                </div>
                                            </div>
                                        </div>
                                        <button className="button is-info is-fullwidth">
                                            <i className="icon"> <CgShoppingCart className="react-icons-sidebar" /> </i>
                                            <span>Checkout</span>
                                        </button>
                                    </div>
                                </div>
